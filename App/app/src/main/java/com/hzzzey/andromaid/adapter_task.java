...
public class adapter_task extends RecyclerView.Adapter<adapter_task.ViewHolder> {
    ...
    public adapter_task(List<task_schedule_item> list, onTaskScheduleLongClick onItemListener) {
        this_list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.timeText.setText(this_list.get(position).getDate()+ " : " + this_list.get(position).getTime());
    }
